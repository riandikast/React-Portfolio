      ...
      >
        <div className=" bg-github-darker-blue w-full h-full ml-60 fixed ">
          <div className="text-white ">
            ...
            <div className="flex h-96 ml-20 ">
              <div>
                <div className="">
                  <div className="mr-12 space-y-6 text-white font-google text-lg font-semibold ml-2 mt-8">
                    <div className="flex rounded-lg px-4 space-x-64 bg-github-medium-blue h-12 w-96  py-2">
